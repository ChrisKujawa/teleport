...
1. Follow the instructions for your package manager:
   ...
   # sudo dnf config-manager --add-repo "$(rpm --eval "https://yum.releases.teleport.dev/rhel/8/Teleport/%{_arch}/${TELEPORT_CHANNEL?}/teleport.repo")"
   # Fedora 41 or later
   $ sudo dnf config-manager addrepo --overwrite --from-repofile="$(rpm --eval "https://yum.releases.teleport.dev/rhel/8/Teleport/%{_arch}/${TELEPORT_CHANNEL?}/teleport.repo")"
